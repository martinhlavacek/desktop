...
const M2sImage = encodePathAsUrl(__dirname, 'static/jsdeveloper_white.svg')
 ...
 * repository.
 */
export class NxButton extends React.Component<IPushPullButtonProps, {}> {
  private push = () => {
